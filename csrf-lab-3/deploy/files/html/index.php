...
<body>
    <div class="dashboard">
        ...
        <div class="user-info">
            ...
            <input type="hidden" id="csrf_token" value="<?php echo isset($_SESSION['admin_token']) && (time() < $_SESSION['admin_token_expire']) ? $_SESSION['admin_token'] : $_SESSION['csrf_token']; ?>">
        </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function deletePost(postId) {
            ...
            fetch(`api.php`, {
                ...
                body: `id=${postId}&action=delete&csrf_token=<?php echo $_SESSION['csrf_token']; ?>`
            })
            .then(response => {
                if (!response.ok) {
